...
<Note>
  This integration supports Mercado Libre accounts in Argentina, Brazil, Mexico, Colombia, Chile, Uruguay, and Peru.
</Note>
...
<CardGroup cols={2}>
  <Card title="Order Import" icon="download">
    Automatically import new orders from Mercado Libre
  </Card>
