...
<CardGroup cols={2}>
  ...
  >
    The largest e-commerce platform in Latin America. Sync orders and inventory in real-time.
  </Card>
  <Card
    title="Tiendanube"
    icon="cloud"
...
| Feature | Mercado Libre | Tiendanube | Shopify |
|---------|---------------|------------|---------|
| Order Import | Yes | Yes | Yes |
| Order Status Sync | Yes | Yes | Yes |
| Product Sync | Yes | Yes | Yes |
| Inventory Sync | Yes | Yes | Yes |
