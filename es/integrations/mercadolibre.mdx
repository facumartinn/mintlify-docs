...
<Note>
  Esta integracion soporta cuentas de Mercado Libre en Argentina, Brasil, Mexico, Colombia, Chile, Uruguay y Peru.
</Note>
...
<CardGroup cols={2}>
  <Card title="Importar Pedidos" icon="download">
    Importa automaticamente nuevos pedidos de Mercado Libre
  </Card>
